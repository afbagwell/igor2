...
| [BUG-017](BUG-017.md) | related to | [BUG-018](BUG-018.md) | Both are resource leaks on the distro image upload path, and both were traced by measuring a real server rather than by reading. Otherwise independent. |
